...
#ifndef COMM_NONUNIFORM_HIERARCHICAL_RING_V1_PUB_H
#define COMM_NONUNIFORM_HIERARCHICAL_RING_V1_PUB_H

#include "comm_base_pub.h"

namespace hccl {
class CommNHRV1 : public CommBase {
public:
    explicit CommNHRV1(const std::string &collectiveId, const u32 userRank,
...
#endif /* COMM_NONUNIFORM_HIERARCHICAL_RING_V1_PUB_H */
