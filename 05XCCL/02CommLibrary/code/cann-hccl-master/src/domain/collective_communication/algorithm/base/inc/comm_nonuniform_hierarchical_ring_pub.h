...
#ifndef COMM_NONUNIFORM_HIERARCHICAL_RING_PUB_H
#define COMM_NONUNIFORM_HIERARCHICAL_RING_PUB_H

#include "comm_base_pub.h"

namespace hccl {
class CommNHR : public CommBase {
public:
    explicit CommNHR(const std::string &collectiveId, const u32 userRank,
...
#endif /* COMM_NONUNIFORM_HIERARCHICAL_RING_PUB_H */
